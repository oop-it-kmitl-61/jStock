 ...
 * @author Passawit
 */
public class ConfirmDeleteItem extends javax.swing.JDialog {
    private String name;
     ...
     */
    public ConfirmDeleteItem(String name, String price, String amount) {
        initComponents();
        this.name = name;
        this.price = price;
        this.amount = amount;
    ...
    private void initComponents() {
        ...
        description.setText("Delete product in stock");
    ...
    public void init() {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConfirmDeleteItem dialog = new ConfirmDeleteItem(name, price, amount);
