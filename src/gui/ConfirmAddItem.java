 ...
 * @author Passawit
 */
public class ConfirmAddItem extends javax.swing.JDialog {
    private String name;
     ...
     */
    public ConfirmAddItem(String name, String price, String amount) {
        initComponents();
        this.name = name;
        this.price = price;
        this.amount = amount;
    ...
    private void initComponents() {
        ...
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(332, 214));
        setResizable(false);
        ...
        description.setText("Add product to stock");
            ...
            .addGroup(bgLayout.createSequentialGroup()
                ...
                .addGroup(bgLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(bgLayout.createSequentialGroup()
                        ...
                        .addComponent(bnAdd, javax.swing.GroupLayout.PREFERRED_SIZE, 67, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        bgLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {bnAdd, bnCancel});
    ...
    public void init() {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConfirmAddItem dialog = new ConfirmAddItem(name, price, amount);
