...
public class ViewTransaction extends javax.swing.JDialog {
                ...
                .addGroup(bgLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(bgLayout.createSequentialGroup()
                        ...
                        .addGroup(bgLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(bnOK, javax.swing.GroupLayout.Alignment.TRAILING))))
                .addGap(30, 30, 30))
        );
    ...
    private void custom() {
        ...
        t.getProductsObj().forEach(p -> {
            model.addRow(new Object[]{(int)p.get("quantity"),
                                      (String)p.get("productName"),
                                      (double)p.get("productPrice"),
                                      (double)p.get("amount")});
        });
    ...
    public void init() {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            ViewTransaction dialog = new ViewTransaction(t);
